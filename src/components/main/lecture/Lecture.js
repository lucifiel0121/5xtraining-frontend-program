      ...
      return (
         <div className="lecture">
                     ...
                     <div className="lecture-lists__item" key={index}>
                        <div className="lecture-card">
                           ...
                           <div className="lecture-card__content">
                              {isLectureNew && (
                                 <span className="badge badge__color badge__color_orange">
                                    新開課
                                 </span>
                              )}
                              {isLectureOpen && (
                                 <span className="badge badge__color badge__color_red">
                                    開放報名中
                                 </span>
                              )}

                              <h4 className="lecture-card__title">
                                 {lectureTitle}
                              </h4>
            ...
            <div className="lecture-btn">
               <button type="button">看更多網頁課程</button>
            </div>
         </div>
      )
   }
